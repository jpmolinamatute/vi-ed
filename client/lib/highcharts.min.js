...
(function () {
    ...
    var y, B = document, K = window, W = Math, s = W.round, V = W.floor, ta = W.ceil, v = W.max, C = W.min, N = W.abs, X = W.cos, aa = W.sin, ma = W.PI, ha = ma * 2 / 360, Ba = navigator.userAgent, Ib = K.opera, ya = /(msie|trident)/i.test(Ba) && !Ib, hb = B.documentMode === 8, ib = /AppleWebKit/.test(Ba), La = /Firefox/.test(Ba), Jb = /(Mobile|Android|Windows Phone)/.test(Ba),
        Ca = "http://www.w3.org/2000/svg", ca = !!B.createElementNS && !!B.createElementNS(Ca, "svg").createSVGRect, Nb = La && parseInt(Ba.split("Firefox/")[1], 10) < 4, fa = !ca && !ya && !!B.createElement("canvas").getContext, $a, ab, Kb = {}, yb = 0, fb, T, Oa, za, zb, D, na = function () {
            return y
        }, Y = [], bb = 0, Ka = "div", O = "none", Ob = /^[0-9]+$/, jb = ["plotTop", "marginRight", "marginBottom", "plotLeft"], Pb = "stroke-width", Aa, gb, ob, eb, sb, tb, ub, Xa, Ya, Za, Db, Eb, Fb, Gb, vb, wb, xb, M = {}, z;
    ...
    z.numberFormat = function (a, b,
                               c, d) {
        var e = T.lang, a = +a || 0, f = b === -1 ? C((a.toString().split(".")[1] || "").length, 20) : isNaN(b = N(b)) ? 2 : b, b = c === void 0 ? e.decimalPoint : c, d = d === void 0 ? e.thousandsSep : d, e = a < 0 ? "-" : "", c = String(F(a = N(a).toFixed(f))), g = c.length > 3 ? c.length % 3 : 0;
    ...
    var U = K.HighchartsAdapter, E = U || {};
    U && U.init.call(U, zb);
    var kb = E.adapterRun, Qb = E.getScript, Ma = E.inArray, o = z.each = E.each,
        lb = E.grep, Rb = E.offset, Ua = E.map, H = E.addEvent, Z = E.removeEvent, I = E.fireEvent, Sb = E.washMouseEvent, mb = E.animate, db = E.stop;
    T = {
    ...
    var Tb = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/, Ub = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/,
        Vb = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/, oa = function (a) {
            var b = [], c, d;
            (function (a) {
    ...
    P.prototype = {
        ...
        colorGradient: function (a, b, c) {
            var d = this.renderer, e, f, g, h, i, j, k, l, m, n, u = [];
    ...
    P.prototype["stroke-widthSetter"] = P.prototype.strokeSetter = function (a, b, c) {
        this[b] = a;
        if (this.stroke &&
            this["stroke-width"])this.strokeWidth = this["stroke-width"], P.prototype.fillSetter.call(this, this.stroke, "stroke", c), c.setAttribute("stroke-width", this["stroke-width"]), this.hasStroke = !0; else if (b === "stroke-width" && a === 0 && this.hasStroke)c.removeAttribute("stroke"), this.hasStroke = !1
    };
    var ua = function () {
    ...
    ua.prototype = {
        Element: P, init: function (a, b, c, d, e) {
            ...
            !f && !n && !u && e.indexOf(" ") === -1 ? b.appendChild(B.createTextNode(t(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, S && S.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) :
                [e], e[e.length - 1] === "" && e.pop(), o(e, function (e, f) {
                var g, m = 0, e = e.replace(/<span/g, "|||<span").replace(/<\/span>/g, "</span>|||");
                g = e.split("|||");
                o(g, function (e) {
                    if (e !== "" || g.length === 1) {
                        var n = {}, r = B.createElementNS(Ca, "tspan"), p;
                        h.test(e) && (p = e.match(h)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), J(r, "style", p));
                        i.test(e) && !d && (J(r, "onclick", 'location.href="' + e.match(i)[1] + '"'), L(r, {cursor: "pointer"}));
                        e = t(e.replace(/<(.|\n)*?>/g, "") || " ");
                        if (e !== " ") {
                            ...
                            J(r, n);
                            b.appendChild(r);
                            !m && f && (!ca && d && L(r, {display: "block"}), J(r, "dy", Q(r)));
                            if (l) {
                                for (var n = e.replace(/([^\^])-/g, "$1- ").split(" "), o = g.length > 1 || f || n.length > 1 && k.whiteSpace !== "nowrap", S, w, q, v = [], y = Q(r), s = 1, x = a.rotation, A = e, C = A.length; (o || u) && (n.length || v.length);)a.rotation = 0, S = a.getBBox(!0), q = S.width, !ca && c.forExport && (q = c.measureSpanWidth(r.firstChild.data, a.styles)), S = q > l, w === void 0 && (w = S), u && w ? (C /= 2, A === "" || !S && C < 0.5 ? n = [] : (S && (w = !0), A = e.substring(0, A.length + (S ? -1 :
                                        1) * ta(C)), n = [A + (l > 3 ? "â€¦" : "")], r.removeChild(r.firstChild))) : !S || n.length === 1 ? (n = v, v = [], n.length && (s++, r = B.createElementNS(Ca, "tspan"), J(r, {
                                    dy: y,
                                    x: j
            ...
            var j = this.label(a, b, c, i, null, null, null, null, "button"), k = 0, l, m, n, u, r, p, a = {
                x1: 0,
                y1: 0,
                x2: 0,
                y2: 1
            ...
            var a = /px/.test(a) ? F(a) : /em/.test(a) ? parseFloat(a) * 12 : 12, c = a < 24 ? a + 3 : s(a * 1.2), d = s(c * 0.8);
            return {h: c, b: d, f: a}
            ...
            function j() {
                ...
                if (E) {
                    ...
                    r.isImg || r.attr(x({width: s(n.width), height: s(n.height)}, G));
                    G = null
                }
            }

            function k() {
                var a = n.styles, a = a && a.textAlign, b = w + t * (1 - Q), c;
                c = h ? 0 : F;
                if (q(ga) && p && (a === "center" || a ===
                    "right"))b += {center: 0.5, right: 1}[a] * (ga - p.width);
            ...
            var m = this, n = m.g(i), u = m.text("", 0, 0, g).attr({zIndex: 1}), r, p, Q = 0, t = 3, w = 0, ga, v, C, B, z = 0, G = {}, F, E;
            n.onAdd = function () {
                u.add(n);
                n.attr({text: a || a === 0 ? a : "", x: b, y: c});
                r && q(e) && n.attr({anchorX: e, anchorY: f})
            };
        ...
        htmlCss: function (a) {
            ...
            if (this.added) {
                var a = this.renderer, b = this.element, c = this.translateX || 0, d = this.translateY ||
                    0, e = this.x || 0, f = this.y || 0, g = this.textAlign || "left", h = {
                    left: 0,
                    center: 0.5,
                    right: 1
                ...
                if (b.tagName === "SPAN") {
                    var k = this.rotation, l, m = F(this.textWidth), n = [k, g, b.innerHTML, this.textWidth].join(",");
                    if (n !== this.cTT) {
            ...
            var d = {}, e = ya ? "-ms-transform" : ib ? "-webkit-transform" : La ? "MozTransform" : Ib ? "-o-transform" : "";
                ...
                if (this.parentGroup = a) {
                    if (b = a.div, !b) {
                        ...
                        o(j.reverse(), function (a) {
                            var d;
                            b = a.div = a.div || $(Ka, {className: J(a.element, "class")}, {
                                    position: "absolute",
    ...
    if (!ca && !fa) {
        E = {
            init: function (a, b) {
                ...
                var b = this.renderer, c =
                    this.element, d = b.box, d = a ? a.element || a : d;
                ...
                for (var b = a.length, c = []; b--;)if (ra(a[b]))c[b] = s(a[b] * 10) - 5; else if (a[b] === "Z")c[b] = "x"; else if (c[b] = a[b], a.isArc && (a[b] === "wa" || a[b] === "at"))c[b + 5] === c[b + 7] && (c[b + 7] += a[b + 7] > a[b + 5] ?
                ...
                var d = [], e, f = this.element, g = this.renderer, h, i = f.style, j, k = f.path, l, m, n, u;
        ...
        var Na = {
            ...
            clipRect: function (a, b, c, d) {
                ...
                if (i) {
                    var k, l, m = a.linearGradient || a.radialGradient, n, u, r, p, Q, t = "", a = a.stops, w, ga = [], q = function () {
                    ...
                    if (c === "fill")if (i === "gradient")c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, n = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, t = 'angle="' + (90 - W.atan((m - a) / (n - c)) * 180 / ma) + '"', q(); else {
                        var j = m.r, v = j * 2, y = j * 2, s = m.cx, x = m.cy, C = b.radialReference, A, j = function () {
    ...
    Ta.prototype = {
        addLabel: function () {
            ...
            q(d) ? d && d.attr({text: b}) : (this.labelLength = (this.label = d = q(b) && g.enabled ? c.renderer.text(b, 0, 0, g.useHTML).css(A(g.style)).add(a.labelGroup) :
            ...
            var b = this.axis, c = a.x, d = b.chart.chartWidth, e = b.chart.spacing, f = p(b.labelLeft, e[3]), e = p(b.labelRight, d - e[1]), g = this.label, h = this.rotation, i = {
                ...
                center: 0.5,
                right: 1
            }[b.labelAlign], j = g.getBBox().width, k = b.slotWidth, l = 1, m;
            if (h)h < 0 && c - i * j < f ? m = s(c / X(h * ha) - f) : h > 0 && c + i * j > e && (m = s((d - c) / X(h * ha))); else if (d = c + (1 - i) * j, c - i * j < f ? k = a.x + k * (1 - i) -
            ...
            var d = this.axis, e = d.options, f = d.chart.renderer, g = d.horiz, h = this.type,
                i = this.label, j = this.pos, k = e.labels, l = this.gridLine, m = h ? h + "Grid" : "grid", n = h ? h + "Tick" : "tick", u = e[m + "LineWidth"], r = e[m + "LineColor"], o = e[m + "LineDashStyle"], Q = e[n + "Length"], m = e[n + "Width"] || 0, t = e[n + "Color"], w = e[n + "Position"], n = this.mark, ga = k.step, q = !0, v = d.tickmarkOffset, s = this.getPosition(g, j, v, b), x = s.x, s = s.y, A = g && x === d.pos + d.len || !g && s === d.pos ? -1 : 1, c = p(c, 1);
            this.isActive = !0;
            if (u) {
                j = d.getPlotLinePath(j + v, u * A, b, !0);
                if (l === y) {
                    l = {stroke: r, "stroke-width": u};
                    if (o)l.dashstyle = o;
                    if (!h)l.zIndex = 1;
                    if (b)l.opacity =
                        0;
            ...
            if (i && !isNaN(x))i.xy = s = this.getLabelPosition(x, s, i, g, k, v, a, ga), this.isFirst && !this.isLast && !p(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !p(e.showLastLabel, 1) ? q = !1 : g && !d.isRadial && !k.step && !k.rotation && !b && c !== 0 && this.handleOverflow(s), ga && a % ga && (q = !1), q && !isNaN(s.y) ? (s.opacity = c, i[this.isNew ? "attr" : "animate"](s), this.isNew = !1) : i.attr("y", -9999)
        }, destroy: function () {
            Qa(this, this.axis)
        }
    };
    ...
    z.PlotLineOrBand.prototype = {
        render: function () {
            var a = this, b = a.axis, c = b.horiz, d = a.options, e = d.label, f = a.label, g = d.width, h = d.to, i = d.from, j = q(i) && q(h), k = d.value, l = d.dashStyle, m = a.svgElem, n = [], u, r = d.color, p = d.zIndex, o = d.events, t =
            {}, w = b.chart.renderer;
            b.isLog && (i = Ea(i), h = Ea(h), k = Ea(k));
            if (g) {
                if (n = b.getPlotLinePath(k, g), t = {stroke: r, "stroke-width": g}, l)t.dashstyle = l
            } else if (j) {
            ...
            if (e && q(e.text) && n && n.length && b.width > 0 && b.height > 0) {
                ...
                n = Pa(b);
                c = Pa(j);
                f.align(e, !1, {x: n, y: c, width: Fa(b) - n, height: Fa(j) - c});
                f.show()
            } else f && f.hide();
            return a
        },
    ...
    va.prototype = {
        ...
        defaultLabelFormatter: function () {
            var a =
                this.axis, b = this.value, c = a.categories, d = this.dateTimeLabelFormat, e = T.lang.numericSymbols, f = e && e.length, g, h = a.options.labels.format, a = a.isLog ? b : a.tickInterval;
            if (h)g = Ja(h, this); else if (c)g = b; else if (d)g = Oa(d, b); else if (f && a >= 1E3)for (; f-- && g === y;)c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = z.numberFormat(b / c, -1) + e[f]);
            ...
            o(a.series, function (c) {
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        ...
                        if (q(d))if (a.dataMin >= d)a.dataMin = d, a.ignoreMinPadding = !0; else if (a.dataMax <
        ...
        getPlotLinePath: function (a, b, c, d, e) {
            ...
            var n = function (a, b, c) {
                ...
                return a
            }, e = p(e, this.translate(a, null, null, c)), a = c = s(e + i);
            i = j = s(k - e - i);
        ...
        adjustForMinRange: function () {
            ...
            if (this.isXAxis && this.minRange === y && !this.isLog)q(a.min) || q(a.max) ? this.minRange = null : (o(this.series, function (a) {
                ...
                0; g--)if (h = i[g] - i[g - 1], f === y || h < f)f = h
        ...
        setAxisTranslation: function (a) {
            ...
            if (k || i || d)if (h ? (f = h.minPointOffset, g = h.pointRangePadding) :
                    o(b.series, function (a) {
                        var h = i ? 1 : k ? a.pointRange : b.axisPointRange || 0, j = a.options.pointPlacement, u = a.closestPointRange;
                        h > c && (h = 0);
                        d = v(d, h);
        ...
        setTickInterval: function (a) {
            var b =
                this, c = b.chart, d = b.options, e = b.isLog, f = b.isDatetimeAxis, g = b.isXAxis, h = b.isLinked, i = d.maxPadding, j = d.minPadding, k = d.tickInterval, l = d.tickPixelInterval, m = b.categories;
        ...
        unsquish: function () {
            var a = this.ticks, b = this.options.labels, c =
                this.horiz, d = this.tickInterval, e = d, f = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / d), g, h = b.rotation, i = this.chart.renderer.fontMetrics(b.style.fontSize, a[0] && a[0].label), j, k = Number.MAX_VALUE, l, m = function (a) {
                a /= f || 1;
                a = a > 1 ? ta(a) : 1;
                return a * d
            };
        ...
        getOffset: function () {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i = b.inverted ? [1, 0, 3, 2][h] : h, j, k, l = 0, m, n = 0, u = d.title, r = d.labels, S = 0, Q = b.axisOffset, b = b.clipOffset, t = [-1, 1, 1, -1][h], w;
        ...
        render: function () {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.isLog, f = a.isLinked, g = a.tickPositions, h = a.axisTitle, i = a.ticks, j = a.minorTicks, k =
                a.alternateBands, l = d.stackLabels, m = d.alternateGridColor, n = a.tickmarkOffset, u = d.lineWidth, r, p = b.hasRendered && q(a.oldMin) && !isNaN(a.oldMin);
            r = a.hasData;
            var Q = a.showAxis, t, w;
            ...
            o([i, j, k], function (a) {
                var c, d, e = [],
                    f = za ? za.duration || 500 : 0, g = function () {
    ...
    va.prototype.normalizeTimeTickInterval = function (a, b) {
        var c = b || [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1, 2]], ["week", [1, 2]], ["month", [1, 2, 3, 4, 6]], ["year", null]], d = c[c.length - 1], e = D[d[0]], f = d[1], g;
    ...
    Mb.prototype = {
        init: function (a, b) {
            ...
            var c, d = this.chart,
                e = d.inverted, f = d.plotTop, g = d.plotLeft, h = 0, i = 0, j, k, a = sa(a);
            c = a[0].tooltipPos;
    ...
    Va.prototype = {
        init: function (a, b) {
            ...
            return x(a, {chartX: s(c), chartY: s(d)})
            ...
            var b = this.chart, c = b.options.chart, d = a.chartX, e = a.chartY, f = this.zoomHor, g = this.zoomVert, h = b.plotLeft, i = b.plotTop, j = b.plotWidth, k = b.plotHeight, l, m = this.mouseDownX, n = this.mouseDownY, u = c.panKey && a[c.panKey + "Key"];
            d < h ? d = h : d > h + j && (d = h + j);
            e < i ? e = i : e > i + k && (e = i + k);
            ...
            if (this.selectionMarker) {
                ...
                if (this.hasDragged || d)o(c.axes, function (c) {
                    if (c.zoomEnabled && q(c.min) && (d || b[{xAxis: "zoomX", yAxis: "zoomY"}[c.coll]])) {
                        var f = c.horiz, n = a.type === "touchend" ? c.minPixelPadding : 0, u = c.toValue((f ? g : h) + n), f = c.toValue((f ? g + i : h + j) - n);
                        e[c.coll].push({axis: c, min: C(u, f), max: v(u, f)});
                        k = !0
                    }
    ...
    x(z.Pointer.prototype, {
        pinchTranslate: function (a, b, c, d, e, f) {
            ...
            (this.zoomVert || this.pinchVert) && this.pinchTranslateDirection(!1, a, b, c, d, e, f)
                                              ...
                                              b, c, d, e, f, g, h) {
            var i = this.chart, j = a ? "x" : "y", k = a ? "X" : "Y", l = "chart" + k, m = a ? "width" : "height", n = i["plot" + (a ? "Left" : "Top")], u, r, p = h || 1, o = i.inverted, t = i.bounds[a ? "h" : "v"], w = b.length === 1, q = b[0][l], v = c[0][l], s = !w && b[1][l], y = !w && c[1][l], x, c = function () {
            ...
            if (a.type === "touchstart")o(e, function (a, b) {
                ...
                if (a.zoomEnabled) {
                    var b = c.bounds[a.horiz ? "h" : "v"], d = a.minPixelPadding, e = a.toPixels(p(a.options.min, a.dataMin)), f = a.toPixels(p(a.options.max, a.dataMax)), g = C(e, f), e = v(e, f);
                    b.min = C(a.pos, g - d);
    ...
    nb.prototype = {
        init: function (a,
            ...
            var b = this.chart, c = b.renderer, d =
                this.options, e = d.layout === "horizontal", f = this.symbolWidth, g = d.symbolPadding, h = this.itemStyle, i = this.itemHiddenStyle, j = this.padding, k = e ? p(d.itemDistance, 20) : 0, l = !d.rtl, m = d.width, n = d.itemMarginBottom || 0, u = this.itemMarginTop, r = this.initialItemX, o = a.legendItem, q = a.series && a.series.drawLegendSymbol ? a.series : a, t = q.options, t = this.createCheckboxForItem && t && t.showCheckbox, w = d.useHTML;
            if (!o) {
                a.legendGroup = c.g("legend-item").attr({zIndex: 1}).add(this.scrollGroup);
                a.legendItem = o = c.text("", l ? f + g : -g, this.baseline ||
                    0, w).css(A(a.visible ? h : i)).attr({align: l ? "left" : "right", zIndex: 2}).add(a.legendGroup);
            ...
            var b = this, c = this.chart, d = c.renderer, e = this.options, f = e.y, f = c.spacingBox.height + (e.verticalAlign === "top" ? -f : f) - this.padding, g = e.maxHeight, h, i = this.clipRect, j = e.navigation, k = p(j.animation, !0), l = j.arrowSize || 12, m = this.nav, n = this.pages, u, r = this.allItems;
    ...
    Na = z.LegendSymbolMixin = {
        drawRectangle: function (a, b) {
            ...
            d = a.symbolWidth;
            var e = this.chart.renderer, f = this.legendGroup, a = a.baseline - s(a.fontMetrics.b * 0.3), g;
            if (b.lineWidth) {
    ...
    E.prototype = {
        callbacks: [], init: function (a, b) {
            ...
            c = ta(v(d, h[0]) / 2);
            this.clipBox = {
                x: b, y: c, width: V(this.plotSizeX - v(d, h[1]) / 2 - b), height: v(0, V(this.plotSizeY - v(d, h[2]) /
                    2 - c))
            };
            ...
            var a = this.options.chart, b = this.renderer, c = this.chartWidth, d = this.chartHeight, e = this.chartBackground, f = this.plotBackground, g = this.plotBorder, h = this.plotBGImage, i = a.borderWidth || 0, j = a.backgroundColor, k = a.plotBackgroundColor, l = a.plotBackgroundImage, m = a.plotBorderWidth ||
                0, n, p = this.plotLeft, o = this.plotTop, q = this.plotWidth, v = this.plotHeight, t = this.plotBox, w = this.clipRect, s = this.clipBox;
            n = i + (a.shadow ? 8 : 0);
            ...
            if (k)f ? f.animate(t) : this.plotBackground = b.rect(p, o, q, v, 0).attr({fill: k}).add().shadow(a.plotShadow);
            if (l)h ? h.animate(t) :
                this.plotBGImage = b.image(l, p, o, q, v).add();
            w ? w.animate({width: s.width, height: s.height}) : this.clipRect = b.clipRect(s);
            ...
            b.items && o(b.items, function (c) {
                var d = x(b.style, c.style), e = F(d.left) +
                    a.plotLeft, f = F(d.top) + a.plotTop + 12;
                delete d.left;
                delete d.top;
    ...
    R.prototype = {
        ...
        setData: function (a, b, c, d) {
            var e = this, f = e.points, g = f && f.length || 0, h, i = e.options, j = e.chart, k = null, l = e.xAxis, m = l && !!l.categories, n = i.turboThreshold, u = this.xData, r = this.yData, q = (h = e.pointArrayMap) && h.length, a = a || [];
            h = a.length;
            b = p(b, !0);
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible)o(a, function (a, b) {
                ...
                if (n && h > n) {
                    ...
                    if (ra(k)) {
                        ...
                        e.xIncrement = m
                    } else if (Ha(k))if (q)for (c = 0; c < h; c++)i = a[c], u[c] = i[0], r[c] = i.slice(1, q + 1); else for (c = 0; c < h; c++)i = a[c], u[c] = i[0], r[c] = i[1]; else la(12)
                } else for (c = 0; c < h; c++)if (a[c] !== y && (i = {series: e}, e.pointClass.prototype.applyOptions.apply(i, [a[c]]), e.updateParallelArrays(i,
        ...
        getExtremes: function (a) {
            ...
            d = a.length;
            for (l = 0; l < d; l++)if (j = c[l], k = a[l], i = k !== null && k !== y && (!b.isLog || k.length || k > 0), j = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[l + 1] || j) >= g && (c[l - 1] || j) <= h,
        ...
        drawPoints: function () {
            var a, b = this.points, c = this.chart, d, e, f, g, h, i, j, k, l = this.options.marker, m = this.pointAttr[""], n, u, o, s = this.markerGroup, q = p(l.enabled, this.xAxis.isRadial, this.closestPointRangePx > 2 * l.radius);
            if (l.enabled !== !1 || this._hasPointMarkers)for (f = b.length; f--;)if (g = b[f], d = V(g.plotX), e = g.plotY, k = g.graphic, n = g.marker || {}, u = !!g.marker, a = q && n.enabled === y || n.enabled, o =
                    g.isInside, a && e !== y && !isNaN(e) && g.y !== null)if (a = g.pointAttr[g.selected ? "select" : ""] || m, h = a.r, i = p(n.symbol, this.symbol), j = i.indexOf("url") === 0, k)k[o ? "show" : "hide"](!0).animate(x({
                x: d - h,
                y: e - h
        ...
        getAttribs: function () {
            ...
            j = b.turboThreshold;
            var r = a.zones, s = a.zoneAxis || "y", v;
        ...
        destroy: function () {
            var a = this, b = a.chart, c = /AppleWebKit\/533/.test(Ba), d, e =
                a.data || [], f, g, h;
            I(a, "destroy");
            Z(a);
        ...
        drawGraph: function () {
            ...
            this.color, b.dashStyle]], d = b.lineWidth, e = b.linecap !== "square", f = this.getGraphPath(), g = this.fillGraph && this.color || O;
        ...
        applyZones: function () {
            var a = this, b = this.chart, c = b.renderer, d = this.zones, e, f, g = this.clips || [], h, i = this.graph, j = this.area, k = v(b.chartWidth, b.chartHeight), l = this[(this.zoneAxis || "y") + "Axis"], m, n = l.reversed, u = b.inverted, r = l.horiz, q, x, t, w = !1;
            if (d.length && (i || j))i && i.hide(), j && j.hide(), m = l.getExtremes(), o(d, function (d, o) {
                ...
                if (l.isXAxis) {
                    if (h =
                        {x: u ? t : x, y: 0, width: q, height: k}, !r)h.x = b.plotHeight - h.x
                } else if (h = {x: 0, y: u ? t : x, width: k, height: q}, r)h.y = b.plotWidth - h.y;
    ...
    Hb.prototype = {
        destroy: function () {
            ...
            var c = this.axis, d = c.chart, e = d.inverted, f = c.reversed, f = this.isNegative && !f || !this.isNegative && f, g = c.translate(c.usePercentage ? 100 : this.total, 0, 0, 0, 1), c = c.translate(0), c = N(g - c), h = d.xAxis[0].translate(this.x) + a, i = d.plotHeight,
                f = {
                    x: e ? f ? g : g - c : h,
    ...
    R.prototype.setStackedPoints = function () {
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            var a = this.processedXData, b = this.processedYData, c = [], d = b.length, e = this.options, f = e.threshold, g = e.startFromThreshold ? f : 0, h = e.stack,
                e = e.stacking, i = this.stackKey, j = "-" + i, k = this.negStacks, l = this.yAxis, m = l.stacks, n = l.oldStacks, o, r, s, q, t, w;
            for (q = 0; q < d; q++) {
                t = a[q];
                w = b[q];
                s = this.index + "," + q;
    ...
    x(E.prototype, {
        addSeries: function (a, b, c) {
            ...
            new va(this, A(a, {index: this[e].length, isX: b}));
            f[e] = sa(f[e] || {});
            f[e].push(a);
            p(c, !0) && this.redraw(d)
    ...
    x(R.prototype, {
        addPoint: function (a, b, c, d) {
            var e = this, f = e.options, g = e.data, h = e.graph, i = e.area, j = e.chart, k = e.xAxis && e.xAxis.names, l = h && h.shift || 0, m = ["graph", "area"], h = f.data, n, u = e.xData;
            Sa(d, j);
            if (c) {
    ...
    xa = ka(R, {
        ...
        getColumnMetrics: function () {
            ...
            var c = C(N(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || c.tickInterval || 1), c.len), j = c * b.groupPadding, k = (c - 2 * j) / i, l = b.pointWidth, b = q(l) ? (k - l) / 2 : k * b.pointPadding, l = p(l, k - 2 * b);
        ...
        translate: function () {
            var a = this, b = a.chart, c = a.options, d = a.borderWidth = p(c.borderWidth, a.closestPointRange * a.xAxis.transA < 2 ? 0 : 1), e = a.yAxis,
                f = a.translatedThreshold = e.getThreshold(c.threshold), g = p(c.minPointLength, 5), h = a.getColumnMetrics(), i = h.width, j = a.barW = v(i, 1 + 2 * d), k = a.pointXOffset = h.offset, l = -(d % 2 ? 0.5 : 0), m = d % 2 ? 0.5 : 1;
            b.inverted && (f -= 0.5, b.renderer.isVML && (m += 1));
            c.pointPadding && (j = ta(j));
            R.prototype.translate.apply(a);
            o(a.points, function (c) {
                var d = p(c.yBottom, f), h = 999 + N(d), h = C(v(-h, c.plotY), e.len + h), o = c.plotX + k, q = j, t = C(h, d), w, x;
                w = v(h, d) - t;
        ...
        drawPoints: function () {
            ...
            o(a.points, function (h) {
                ...
                if (i !== y && !isNaN(i) && h.y !==
                    null)f = h.shapeArgs, i = q(a.borderWidth) ? {"stroke-width": a.borderWidth} : {}, g = h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""], j ? (db(j), j.attr(i)[b.pointCount < e ? "animate" : "attr"](A(f))) : h.graphic = d[h.shapeType](f).attr(i).attr(g).add(a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius); else if (j)h.graphic = j.destroy()
            })
        },
        animate: function (a) {
    ...
    U = {
        ...
        translate: function (a) {
            ...
            for (m = 0; m < n; m++) {
                ...
                o.slicedTranslation = {translateX: s(X(h) * d), translateY: s(aa(h) * d)};
                f = X(h) * a[2] / 2;
                g = aa(h) * a[2] / 2;
    ...
    R.prototype.drawDataLabels = function () {
        ...
        if (d.enabled || a._hasPointLabels)a.dlProcessOptions && a.dlProcessOptions(d), j = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", d.zIndex || 6), p(d.defer, !0) && (j.attr({opacity: +h}), h || H(a, "afterAnimate", function () {
            ...
            var h, n = e.dataLabel, o, r, s = e.connector, v = !0, t, w = {};
    ...
    R.prototype.alignDataLabel = function (a, b, c, d, e) {
        var f = this.chart, g = f.inverted, h = p(a.plotX, -999), i = p(a.plotY, -999), j = b.getBBox(), k = f.renderer.fontMetrics(c.style.fontSize).b, l = this.visible && (a.series.forceDL || f.isInsidePlot(h, s(i), g) || d && f.isInsidePlot(h, g ? d.x +
            1 : d.y + d.height - 1, g));
        if (l)d = x({
            x: g ? f.plotWidth - i : h,
    ...
    if (M.pie)M.pie.prototype.drawDataLabels =
        function () {
            var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = p(e.connectorPadding, 10), g = p(e.connectorWidth, 1), h = d.plotWidth, i = d.plotHeight, j, k, l = p(e.softConnector, !0), m = e.distance, n = a.center, q = n[2] / 2, r = n[1], x = m > 0, y, t, w, A = [[], []], B, z, F, E, G, D = [0, 0, 0, 0], L = function (a, b) {
                return b.y - a.y
            };
            if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                for (E = 2; E--;) {
                    ...
                    if (K) {
                        ...
                        for (G =
                            ...
                            y._attr = {visibility: F, align: w[6]};
                            y._pos = {x: B + e.x + ({left: f, right: -f}[w[6]] || 0), y: z + e.y - 10};
                            y.connX = B;
                            y.connY = z;
                ...
                if (Fa(D) === 0 || this.verifyDataLabelOverflow(D))this.placeDataLabels(), x && g && o(this.points, function (b) {
                    j = b.connector;
                    w = b.labelPos;
                    if ((y = b.dataLabel) && y._pos && b.visible)F = y._attr.visibility, B = y.connX, z = y.connY, k = l ? ["M", B + (w[6] === "left" ? 5 : -5), z, "C", B, z, 2 * w[2] - w[4], 2 * w[3] - w[5], w[2], w[3], "L", w[4], w[5]] : ["M", B + (w[6] === "left" ? 5 : -5), z, "L", w[2], w[3], "L", w[4], w[5]], j ? (j.animate({d: k}), j.attr("visibility", F)) : b.connector = j = a.chart.renderer.path(k).attr({
                        "stroke-width": g, stroke: e.connectorColor ||
                        b.color || "#606060", visibility: F
        ...
        showResetZoom: function () {
            ...
            o(b === "xy" ? [1, 0] : [1], function (b) {
                ...
                if (h.series.length && (i || l > C(k.dataMin, k.min)) && (!i || j < v(k.dataMax,
                        k.max)))h.setExtremes(l, j, !1, !1, {trigger: "pan"}), e = !0;
    ...
    x(Ga.prototype, {
        select: function (a, b) {
            ...
            if (!this.hasImportedEvents) {
                var a =
                    A(this.series.options.point, this.options).events, b;
                this.events = a;
